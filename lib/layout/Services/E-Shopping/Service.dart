                        ...
                        children: [
                                  ...
                                  Padding(
                                    ...
                                    child: Container(
                                      ...
                                      child: ListView.separated(
                                        ...
                                        itemCount:
                                            HomeCubit.get(context).name4.length,
                                      ),
                                    ),
                                  ),
                                ],
                          ...
                          if (HomeCubit.get(context).nameIndex == 0)
                            Padding(
                              ...
                              child: ListView.builder(
                                itemCount:
                                    HomeCubit.get(context).all4List.length,
                                physics: const BouncingScrollPhysics(),
                                shrinkWrap: true,
                                itemBuilder: (context, index) => buildProduct(
                                    context,
                                    size,
                                    HomeCubit.get(context).all4List[index],
                                    index),
                              ),
                            ),
                          if (HomeCubit.get(context).nameIndex == 1)
                            Padding(
                              ...
                              child: ListView.builder(
                                itemCount:
                                    HomeCubit.get(context).shopList.length,
                                physics: const BouncingScrollPhysics(),
                                shrinkWrap: true,
                                itemBuilder: (context, index) => buildProduct(
                                    context,
                                    size,
                                    HomeCubit.get(context).shopList[index],
                                    index),
                              ),
                            ),
